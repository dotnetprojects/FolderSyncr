...
public static class ThemeManager
{
    public static void Apply(bool dark)
    {
        ...
        {
            ApplyTo(resources, dark);
        }
    }

    public static void ApplyTo(ResourceDictionary resources, bool dark)
    {
        if (dark)
        {
            ...
            Set(resources, SystemColors.WindowBrushKey, "#0B1220");
            Set(resources, SystemColors.WindowTextBrushKey, "#E5E7EB");
        ...
        else
        {
            ...
            Set(resources, SystemColors.WindowBrushKey, "#FFFFFF");
            Set(resources, SystemColors.WindowTextBrushKey, "#111827");
